...
class StreamSearchResponse:
    def __init__(
        ...
        num_tokens_used: int,
        websearch_docs: List[WebSearchDocument],
        answer: str = "",
    ) -> None:
...
def stream_search():
    ...
    def generate():
        ...
        yield StreamSearchResponse(
            success=True,
            stage=SearchAllStage.QUERIED_GOOGLE,
            num_tokens_used=0,
        ...
        yield StreamSearchResponse(
            success=True,
            stage=SearchAllStage.DOWNLOADED_WEBPAGES,
            num_tokens_used=num_tokens_used,
            websearch_docs=websearch_docs_scraped,
        ).to_json_data()
        ...
        yield StreamSearchResponse(
            success=True,
            stage=SearchAllStage.RESULTS_READY,
            num_tokens_used=num_tokens_used,
            websearch_docs=websearch_docs_scraped,
            answer=answer,
        ).to_json_data()
